...
export function deleteSymptom(id: string): boolean {
  ...
  // Background sync DELETE to API
  apiFetch(`symptoms?id=${encodeURIComponent(id)}`, { method: "DELETE" }).catch(() => {});
  return true;
}
...
export function deleteMeal(id: string): boolean {
  ...
  // Background sync DELETE to API
  apiFetch(`meals?id=${encodeURIComponent(id)}`, { method: "DELETE" }).catch(() => {});
  return true;
}
...
export function deleteSupplement(id: string): boolean {
  ...
  // Background sync DELETE to API
  apiFetch(`supplements?id=${encodeURIComponent(id)}`, { method: "DELETE" }).catch(() => {});
  return true;
}
